...
<form name="wprb-set-last-minute" class="wprb-set-last-minute wprb-form"  method="post" action="">
	...
	<table class="form-table">
		...
		<tr class="wprb-last-minute-description-field">
			...
			<td>
				<textarea name="wprb-last-minute-description" class="wprb-last-minute-description regular-text" rows="3" placeholder="<?php esc_html_e( 'More information about Last Minute ', 'wprb' ); ?>"><?php echo esc_html( $last_minute_description ); ?></textarea>
