...
class WPRB_Admin {
	...
	public function hours_element( $day, $number = 1, $data = array() ) {
		...
		echo '<div class="wprb-hours-element-' . esc_attr( $number ) . ' hours-element">';
			...
			echo '<input type="time" name="wprb-' . esc_attr( $day ) . '-bookable-hours-from-' . esc_attr( $number ) . '" id="wprb-' . esc_attr( $day ) . '-bookable-hours-from" class="wprb-bookable-hours-from" max="23:59" value="' . esc_attr( $from ) . '" required' . $disabled . '>';

			echo '<label for="wprb-bookable-hours-to">' . esc_html__( 'to', 'wp-restaurant-booking' ) . '</label>';
			echo '<input type="time" name="wprb-' . esc_attr( $day ) . '-bookable-hours-to-' . esc_attr( $number ) . '" id="wprb-' . esc_attr( $day ) . '-bookable-hours-to" class="wprb-bookable-hours-to" max="23:59" value="' . esc_attr( $to ) . '" required' . $disabled . '>';
