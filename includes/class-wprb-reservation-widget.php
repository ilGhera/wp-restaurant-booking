...
class WPRB_Reservation_Widget {
	...
	public function wprb_scripts() {
        ...
        $datepicker_lang = sprintf( '%sjs/air-datepicker/dist/js/i18n/datepicker.%s.js', WPRB_URI, $locale[0] );
        ...
        wp_enqueue_script( 'datepicker-loc', $datepicker_lang, array( 'jquery' ), '2.2.3', true );
	...
	public function step_4( $first_name, $email ) {
		...
		echo '<div class="booking-end" data-title="' . esc_html__( 'Reservation completed', 'wp-restaurant-booking' ) . '">';
			...
			echo '<p class="wprb-step-description">';
				...
				printf( esc_html__( 'Thanks %s! ', 'wp-restaurant-booking' ), esc_html( $first_name ) ) . '<br>';

				echo esc_html__( 'We sent an e-mail with the confirmation data to', 'wp-restaurant-booking' ) . '<br>';
