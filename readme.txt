...
**WP Restaurant Booking - Premium** is a feature-rich and easy to use reservation system for bars and restaurants.
...
* Bug: Wrong premium key message even when valid 


= 1.1.9 = 
Release Date: 2 August 2023

* Enhancement: New admin notification for license expiration 
* Update: Plugin Update Checker
...
* Enhancement: Style implementation in hours settings 
* Enhancement: Translation updated 
* Bug fix: Incorrect text in the widget during the first stage of the booking process
...
* Update: Plugin Update Checker
* Bug Fix: Time set possible only from 12:00
...
* Enhancement: Calendar language set automatically according to the WordPress locale
* Bug Fix: Date missed in saved reservations


= 1.1.4 = 
Release Date: 25 May 2021

* Bug Fix: Privacy policy option saved not shown in back-end


= 1.1.3 = 
Release Date: 24 May 2021

* Enhancement: Privacy policy option
* Bug Fix: Reservation saved in back-end even without accepting only external table
...
* Bug Fix: Duplicate reservations by clicking the send button several times
...
* Bug Fix: Tooltip not available on mobile
